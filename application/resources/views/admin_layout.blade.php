...
<html>
  ...
  <body class="hold-transition fixed skin-blue sidebar-mini">
            ...
            <section class="col-lg-7 connectedSortable">
              ...
              <div class="box box-success">
                ...
                <div class="box-body chat" id="chat-box">
                  <!-- chat item -->
                  <div class="item">
                    {!! Html::image('assets/img/user4-128x128.jpg','user image', array('class' => 'online')) !!}
                    <p class="message">
                      <a href="#" class="name">
                  ...
                  <!-- chat item -->
                  <div class="item">
                    {!! Html::image('assets/img/user3-128x128.jpg','user image', array('class' => 'offline')) !!}
                    <p class="message">
                      <a href="#" class="name">
                  ...
                  <!-- chat item -->
                  <div class="item">
                    {!! Html::image('assets/img/user2-160x160.jpg','user image', array('class' => 'online')) !!}
                    <p class="message">
                      <a href="#" class="name">
    ...
    <?php foreach($data['js_assets'] as $key => $assets ){ echo '<script src="'.$assets.'"></script>
    '; } ?>
